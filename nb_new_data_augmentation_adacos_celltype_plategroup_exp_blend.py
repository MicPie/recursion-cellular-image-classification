...
class RicapCallback(LearnerCallback):
    ...
    def on_batch_begin(self, last_input, last_target, train, **kwargs):
        ...
        last_input, _ = last_input # get input from tuple (last_input, last_target)
        ...
        #patched_images = (patched_images, new_target) # create new input tuple

        return {'last_input': (patched_images, new_target), 'last_target': new_target}
...
class CutMixCallback(LearnerCallback):
    ...
    def on_batch_begin(self, last_input, last_target, train, **kwargs):
        ...
        #last_input, _ = last_input # get input from tuple (last_input, last_target)
        (last_input, last_cint, last_pgint, last_exp), _ = last_input
        # get input from tuple ((last_input, last_cint, last_pgint), last_target)
        ...
        x1_exp = last_exp[idx] # x1_exp for mix!
        ...
        #new_input = (new_input, new_target) # new input tuple
        #new_input = ((new_input, new_cint), new_target) # new input tuple
        
        return {'last_input': ((new_input, new_cint, new_pgint, new_exp), new_target), 'last_target': new_target}
...
class BlendCallback(LearnerCallback):
    ...
    def on_batch_begin(self, last_input, last_target, train, **kwargs):
        ...
        if not train: return {'last_input': ((last_input, last_cint, last_pgint, last_exp), last_target),
                              'last_target': last_target}
        if self.alpha == 0 and self.fixed_proba == 0:
            return {'last_input': ((last_input, last_cint, last_pgint, last_exp), last_target),
                    'last_target': last_target}
        ...
        if w == 0 or h == 0: return {'last_input': ((last_input, last_cint, last_pgint, last_exp), last_target),
                                     'last_target': last_target}
        ...
        if n_mod_patches == 0: return {'last_input': ((last_input, last_cint, last_pgint, last_exp), last_target),
                                       'last_target': last_target}
        ...
        x1_pgint = last_pgint[idx] # x1_pgint for mix!
        x1_exp = last_exp[idx] # x1_exp for mix!
        new_cint = (last_cint, x1_cint, lambd)
        new_pgint = (last_pgint, x1_pgint, lambd)
        new_exp = (last_exp, x1_pgint, lambd)
        ...
        return {'last_input': ((patched_images, new_cint, new_pgint, new_exp), new_target), 'last_target': new_target}
